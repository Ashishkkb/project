...
export default function Footer() {
  return (
    <footer className="bg-[#1B2E1E] text-white py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-semibold text-[#96B66C]">PurePickers</span>
            </div>
            <p className="text-gray-300 mb-8 max-w-md">
              Pure Pickers Agri Pvt Ltd is a commodity trading enterprise is a part of export agricultural products.
            </p>
            <div className="flex space-x-6">
              <a href="#" className="text-[#96B66C] hover:text-white transition-colors">
